...
- документации по css-методологии (style guide) i-am-css
- примеров вёрстки(возможно сравнительных с другими методологиями). Больше склоняюсь к использованию codepen.
- открытых обсуждений и ответов на ваши вопросы по i-am-css в разделе [issues на GitHub](https://github.com/viT-1/iAMcss/issues).
...
- Общение с апологетами БЭМа из команды Яндекса [i-am-css](https://github.com/bem/bem-method/issues/455)
