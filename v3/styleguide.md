...
В вёрстке, в качестве значения атрибута уже нет смысла указывать родительскиие iam-block,
так как можно задать значения переменных для дочерних блоков в "контекстном" селекторе `[iam-parent-block]`,
а не в `[iam-another-block ~= iam-parent-block]`.
