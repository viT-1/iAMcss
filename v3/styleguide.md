...
v3.2.1 среди переменных подразумевает использование [space-toggler](https://github.com/propjockey/css-sweeper#basics-of-space-toggle),
как контекстной переменной, позволяя всю логику разместить поближе к основному (index) селектору.
...
/* контекстный (для элементов блока родительский) селектор */
[iam-collapser] {
...
В "основном" селекторе элемента допустимо прописывать fallback'и на случай отсутствия определения переменной.
