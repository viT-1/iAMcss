...
v3 позволяет уменьшить [специфичность](https://developer.mozilla.org/ru/docs/Web/CSS/Specificity) от иерархичности селекторов, размещая контекст в рамках скобок "[]", а не через пробел. Но и специфичности не стоит избегать любой ценой (но стремиться её уменьшить).
