...
Гугл, кстати, решил уйти от блоков[^1], и [опирается на элементы](https://habrahabr.ru/company/dataart/blog/270109/),
...
[^1]: по прошествию времени, и я сделал вывод, что "блок" это лишь контекстный модификатор.
...
Варианты: `.block[element *= "-mod-"]` (iAMcss 1.0), `.element[block *= "-mod-"]` ("вывернутый" iAMcss 1.0),
`*[block__element *= "-mod-"]` (iAMcss 2.0) и `*[element *= "^block^"][element *= "-mod-"]` (iAMcss 3.0)
...
/* iAMcss 3.0 с блочно-контекстным модификатором */
*[x-list *= "^my-tree^"] {}
```
...
В iAMcss 3.0 для указания блока как модификатора, использовать "^" [^1].
...
.my-iMenu.my-iTreeTooltip[x-hoverlabel]:hover {} /* доп. контекст дедушкиного блока см. [Миксы](#Миксы) */
.my-iMenu.[x-hoverlabel]:hover {} /* но надо быть проще и ограничиваться рамками одного блока */
.my-iTreeTooltip[x-hoverlabel *= "-loading-"] {}

/* iAMcss 1.0 inverted */
.item[my-tree][aria-expanded = "true"] {}
.hoverlabel[my-tree-tooltip]:hover {}
.hoverlabel[my-tree-tooltip][my-menu]:hover {} /* доп. контекст дедушкиного блока см. [Миксы](#Миксы) */
.hoverlabel[my-menu]:hover {} /* но надо быть проще и ограничиваться рамками одного блока */
.hoverlabel[my-tree-tooltip *= -loading-] {}

/* iAMcss 2.0 */
*[data-my-tree__item][aria-expanded = "true"] {}
*[data-my-tree-tooltip__hoverlabel]:hover {}
*[data-my-tree-tooltip__hoverlabel *= "^my-menu^"]:hover {} /* доп. контекст дедушкиного блока см. [Миксы](#Миксы) */
...
*[x-hoverlabel *= "^my-menu^^my-tree-tooltip^"]:hover {} /* доп. контекст дедушкиного блока см. [Миксы](#Миксы) */
...
а по iAMcss 3.0 `*[x-cell *= "^my-table^"]*[x-cell *= "-header-"]`
