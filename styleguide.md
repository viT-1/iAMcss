...
## Каким образом iAMcss решает CSS hell
...
iAMcss, решает задачу указания контекста dom-ноды по-разному: как схожим с классическим БЭМ, схожим с ABEM и более гибко.
...
Относительно БЭМ, iAMcss 3.1 не заморачивает разработчика рассуждениями о разделении на блок и элемент,
...
Атрибут в iAMcss 1.0 аналогичен понятию "[Элемент](https://ru.bem.info/methodology/quick-start/#Элемент)" в БЭМ
или, по iAMcss 3.1 аналогичен понятию Блок-Элемент (версия 2 поддерживает обе декларации).
...
для состояния active. Переопределять такие селекторы повышая специфичность ещё сильнее, накручивая к тому же important - тупиковый путь, потому следует к тем правилам миксовать простейший БЭМ или iAMcss, [например так](https://github.com/viT-1/iAMcss-samples/commit/4bcecb8d9f85b9bd9c80e4d5725ca96d2cc2ddfa).
