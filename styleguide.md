...
- [Виджет vp-tree__list JSON](https://codepen.io/viT-1/pen/XVxEgX) по iAMcss 2.0 и SVG-иконками разных размеров (2018.01.18) ([то же](https://vit-1.github.io/iAMcss/samples/tree/list.xml), но с XML-трансформацией)