...
В целом каскад не одобряется, хотя бы потому, что вам самим неудобно работать с селекторами
...
от стилистики маркировки элементов до БЭМа - всё в class. Если у вас есть необходимость чётко
