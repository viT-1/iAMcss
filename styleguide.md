...
В iAMcss 1.0 конструкция .iParentName[child-name] более специфична чем *[parent-name__child-name],
к тому же именования расположены в разных атрибутах (class и my-custom-attr), что добавляет путанницы.
Контекстные селекторы тоже повышают специфичность, потому .iParentName > .iChildName не выход.
Эта проблема особенно актуальна, когда вы начинаете [выносить оформление элемента, которое может
быть различным](https://ru.bem.info/forum/656/) и зависит от того в каком родительском элементе он находится.
